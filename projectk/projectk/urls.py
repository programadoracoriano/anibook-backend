...
urlpatterns = [
    ...
    path('list/customlist/', ListCustomListAPI, name="listcustomlist"),
    path('create/anime/custom/list', AddAnimeCustomListAPI, name="addanimecustomlist"),
    path('list/anime/customlist/', ListCustomListAnimeAPI, name="listanimecustomlist"),
